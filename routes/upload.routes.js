...
const { parseDocument, isSupported, getMaxFileSize } = require('../services/insightops/documentParser');
...
router.post('/', upload.single('file'), asyncHandler(async (req, res) => {
    ...
    const { workspaceId, type = 'Notes' } = req.body;
    const author = req.user?.email || req.user?.name || 'system';
    ...
    try {
        ...
        try {
            const { summarizeDocument } = require('../services/insightops/aiSummarizer');
